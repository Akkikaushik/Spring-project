...
public class EmployeeController {
    ...
    private static String BASE_URL = "http://localhost:8085/api/";
    ...
    public String saveEmployee(@ModelAttribute Employee employee) {
        restTemplate.postForObject(BASE_URL + "employees", employee, Employee.class);
    ...
    public String updateEmployee(@ModelAttribute Employee employee) {
        restTemplate.patchForObject(BASE_URL + "employees", employee, Employee.class);
        return "redirect:/employees";
    }
